...
public class PurchaseIntegrationTest {
    ...
    String pathHappy = "src/test/java/ma/zs/stocky/integration/core/money/purchase/PurchaseHappyTest.feature";
    String pathSad = "src/test/java/ma/zs/stocky/integration/core/money/purchase/PurchaseSadTest.feature";
